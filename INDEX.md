...
| [Postman collection](https://github.com/ricsnsuka/FootMania-Back/tree/master/postman) | backend `postman/` — generated from `/v3/api-docs` by `generate-collection.mjs`, 103 requests. Rerun the script after an API change |
