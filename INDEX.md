...
| [RANK-LADDER-PLAN](backend/plans/RANK-LADDER-PLAN.md) 📋 | SPECIFIED, not built — Iron→Master tiers of three 75-FP divisions in front of the raw rating, **Form Points** paid per match from result and performance, three placement matches per season, a soft reset that reads FP, and **Best of the Crop** for the top Masters. Owner decisions taken 2026-09-04; every other constant waits for a history replay (§8). Target `3.5.0` |
