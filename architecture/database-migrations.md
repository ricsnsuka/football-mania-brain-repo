...
Complete as of **V37**, verified against `src/main/resources/db/migration/` on 2026-08-08.
...
⚠️ **V37 is written, not merged and not deployed.** It carries `season_awards` and is the first
schema change the seasons work has needed — the write API and the season-bounded league table both
went in without one.
