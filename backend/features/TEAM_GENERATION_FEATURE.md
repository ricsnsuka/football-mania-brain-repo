...
[`docs/frontend/DRAFT_SESSION_SSE_GUIDE.md`](../frontend/DRAFT_SESSION_SSE_GUIDE.md) for the
...
- [`docs/frontend/DRAFT_SESSION_SSE_GUIDE.md`](../frontend/DRAFT_SESSION_SSE_GUIDE.md) — Frontend SSE integration guide
