...
| Team generation (7 strategies, MANUAL through the plan since 2026-09-15) | ✅ | ✅ | [TEAM_GENERATION_FEATURE](../backend/features/TEAM_GENERATION_FEATURE.md) · [design](../backend/features/TEAM_GENERATION_DESIGN.md) · [OPTIMAL plan](../backend/plans/OPTIMAL-PARTITION-PLAN.md) · [FE](../frontend/features/team-generation.md) |
