...
|---|---|---|---|
| Players & roster | ✅ | ✅ | [PLAYER_FEATURE](../backend/features/PLAYER_FEATURE.md) · [player contract](../backend/api/player-API-CONTRACT.md) · [FE players](../frontend/features/players.md) |
| Accounts & auth (JWT) | ✅ | ✅ | [USERS](../backend/features/USERS.md) · [FE login](../frontend/features/login.md) |
| Account ↔ player self-link | ✅ | ✅ | [link-me contract](../backend/api/PLAYER-LINK-ME-API-CONTRACT.md) · [plan](../backend/plans/PLAYER-LINK-ME-PLAN.md) |
...
| Skill ratings & recalculation | ✅ | — | [CALCULATION_SERVICE](../backend/features/CALCULATION_SERVICE.md) · [recalc contract](../backend/api/MATCH-RATING-RECALCULATION-API-CONTRACT.md) |
...
| Draft sessions (captain pick, SSE) | ✅ | ✅ | [DRAFT_SESSION_FEATURE](../backend/features/DRAFT_SESSION_FEATURE.md) · [SSE guide](../backend/frontend/DRAFT_SESSION_SSE_GUIDE.md) |
...
| Privacy / GDPR export & erasure | ✅ | ✅ `ce9ab08` | [PRIVACY_AND_DATA_PROTECTION](../backend/features/PRIVACY_AND_DATA_PROTECTION.md) · [contract](../backend/api/PRIVACY-API-CONTRACT.md) · [FE](../frontend/features/privacy.md) |
| Phase 1 — PWA (installable, offline, SW) | — | ✅ | [FE pwa](../frontend/features/pwa.md) |
| Phase 2 — Web Push (VAPID, 7 categories) | ✅ `80e9b5f`, `aaff369` | ✅ | [PUSH contract](../backend/api/PUSH-API-CONTRACT.md) · [FE push](../frontend/features/push-notifications.md) |
| Balance at a glance | — | ✅ `f8798cc` | [FE team-generation](../frontend/features/team-generation.md) |
| Leaderboards & rankings | ✅ `2e3018e` | ✅ `6d27431` | [LEADERBOARDS contract](../backend/api/LEADERBOARDS-API-CONTRACT.md) · [FE rankings](../frontend/features/rankings.md) |
| Crowd MOTM voting (V14) | ✅ `cf3240e` | ✅ `139e0ed` | [MOTM contract](../backend/api/MOTM-API-CONTRACT.md) · [FE motm-voting](../frontend/features/motm-voting.md) |
| Achievement badges (V15) | ✅ `45fff7e` | ✅ `1af7973` | [BADGES contract](../backend/api/BADGES-API-CONTRACT.md) · [FE badges](../frontend/features/badges.md) |
...
| Feature | Backend | Frontend | Documentation |
|---|---|---|---|
| Runtime-configurable competition rules (V16) | ✅ `c4d6312` | ✅ | [ADMIN contract](../backend/api/ADMIN-API-CONTRACT.md) · [FE settings](../frontend/features/settings.md) |
| Admin settings & system endpoints | ✅ `c7d3554` | ✅ `2b961a3` | [ADMIN contract](../backend/api/ADMIN-API-CONTRACT.md) |
| Composable roles (V18) | ✅ `d6b908f` | ✅ `418256e` | [ROLES contract](../backend/api/ROLES-API-CONTRACT.md) · [migration plan](../backend/plans/ROLE-MODEL-MIGRATION-PLAN.md) · [FE roles](../frontend/features/roles.md) |
| Match fee ledger (V19) | ✅ `828db3b` | ✅ `a3efac0` | [PAYMENTS contract](../backend/api/PAYMENTS-API-CONTRACT.md) · [ledger plan](../backend/plans/MATCH-FEE-LEDGER-PLAN.md) · ⚠️ **no FE feature doc** |
| Pitch cost on `MatchPlanDTO` | ✅ `e87d624` | ✅ `4f47bf5` | ⚠️ **documented nowhere** |
| i18n — en / pt / es | — | ✅ | [FE i18n guide](../frontend/guides/i18n.md) · [language switcher](../frontend/features/language-switcher.md) |
