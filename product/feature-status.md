...
| Seasonal awards — POTS, Golden Boot, Playmaker, Iron Man, Most improved, Crowd favourite | ⬜ | ⬜ | Branch 2. POTS is the average per-match performance rating; MIPS is the biggest rating gain |
| Ballon d'Or — season-change poll | ⬜ | ⬜ | Branch 3. Opens on finalise, closes when the new season's 2nd match completes |
